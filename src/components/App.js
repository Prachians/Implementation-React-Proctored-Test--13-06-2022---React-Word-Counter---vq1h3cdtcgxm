    ...
    <div id='container'>
      ...
      <div>
        <p>Word limit input </p>
         <input type="number" id="char-limit-input" defaultValue={limit} onChange = {(event) => {
      ...
      >    
           ...
           <div id="word-counter">Total number of words written
        <span className='num'> {state.wordCount}</span> 
      </div>
      <div id="char-counter">Total number of characters used
